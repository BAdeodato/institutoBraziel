...
import 'package:instituto_braziel/pages/_login.dart';
...
class _HomeState extends State<Home> {
  ...
  logout() async {
    try {
      ...
      // No need for Navigator.push!
      // AuthCheck will detect the null user and show the Login screen automatically.
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    if (auth.usuario == null && !auth.isLoading) {
      return Login(); // Or Navigator.pushReplacementNamed(...)
    }
